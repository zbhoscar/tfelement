...
def inference(input_tensor,train,regularizer):
	with tf.variable_scope('layer1_conv1'):
		...
		biases=tf.get_variable('biases',[CONV1_DEEP],initializer=tf.constant_initializer(0.1))
	...
	with tf.variable_scope('layer3_conv2'):
		weights=tf.get_variable('weights',[CONV2_SIZE,CONV2_SIZE,CONV1_DEEP,CONV2_DEEP],\
			initializer=tf.truncated_normal_initializer(stddev=0.1))
		biases=tf.get_variable('biases',[CONV2_DEEP],initializer=tf.constant_initializer(0.1))
	...
	with tf.variable_scope('layer5_fc1'):
		weights=tf.get_variable('weights',[nodes,FC_SIZE],\
			initializer=tf.truncated_normal_initializer(stddev=0.1))
	...
	with tf.variable_scope('layer6_fc2'):
		weights=tf.get_variable('weights',[FC_SIZE,NUM_LABELS],\
			initializer=tf.truncated_normal_initializer(stddev=0.1))
		biases=tf.get_variable('biases',[NUM_LABELS],initializer=tf.constant_initializer(0.1))
		if regularizer != None:
			tf.add_to_collection('losses',regularizer(weights))
