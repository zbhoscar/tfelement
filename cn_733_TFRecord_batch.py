...
files = tf.train.match_filenames_once(r'D:\Code_win\Deep_Learning_with_TensorFlow\1.0.0\Chapter07\Records\data.tfrecords-*')
...
test_batch=tf.train.batch(features,batch_size=batch_size,
			capacity=capacity)
