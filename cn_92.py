...
import mnist_inference_92 as mnist_inference
...
MODEL_NAME = 'm64.ckpt'
mnist_path = r'D:\Desktop\Deep_Learning_with_TensorFlow\datasets\MNIST_data'
summary_path = r'D:\Desktop\Deep_Learning_with_TensorFlow\logfile'
...
def train(mnist):
    ...
    with tf.name_scope('imput_image'):
        ...
        tf.summary.image('ip_image', image_shaped_input, 10)
    ...
    with tf.Session(config=config) as sess:
        ...
        for i in range(TRAINING_STEPS):
            ...
            if i % 1000 == 999:
                ...
                _, loss_value, step, summary ,a,b= sess.run([train_op, loss, global_step, merged, y, cross_entropy],
                                                        feed_dict={x: xs, y_: ys}, options=run_options,
                ...
                print('After %d steps,loss = %g' % (step, loss_value))
            ...
            # saver.save(sess,os.path.join(MODEL_SAVE_PATH,MODEL_NAME),global_step=global_step)
                ...
                # writer = tf.summary.FileWriter(r'D:\Code_win\tf_test\temp\modified_mnist_train.log',
