...
DATA_PATH = r"D:\Code_win\tf_test\temp\output.tfrecords"

# MODEL_SAVE_PATH='/home/zbh/Desktop/tf_test/models'
# MODEL_NAME='model.ckpt'
# DATA_PATH='/home/zbh/Desktop/tf_test/output.tfrecords'
...
def get_input():
	...
	return tf.train.shuffle_batch([images, labels],batch_size=batch_size,capacity=capacity,
		num_threads=10,min_after_dequeue=min_after_dequeue)
...
def get_loss(x,y_,regularizer,scope,reuse_variables=None):
	...
	regularaztion_loss=tf.add_n(tf.get_collection('losses',scope))
	loss = cross_entropy_mean + regularaztion_loss
	return loss
