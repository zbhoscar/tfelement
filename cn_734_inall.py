...
if platform.system()=='Linux':
    files = tf.train.match_filenames_once('/home/zbh/Desktop/output.tfrecords')
elif platform.system()=='Windows':
    files = tf.train.match_filenames_once([r'D:\Desktop\Deep_Learning_with_TensorFlow\1.0.0\Chapter07\Records\output.tfrecords'])
files=[r'D:\Desktop\Deep_Learning_with_TensorFlow\1.0.0\Chapter07\Records\output.tfrecords']
...
image_batch, label_batch = tf.train.shuffle_batch([images, labels], 
    batch_size=batch_size,capacity=capacity, num_threads= cpu_count(),
...
time_end=time.time()
print('program lasts %d s.' % (time_end-time_start))
