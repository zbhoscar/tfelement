...
MODEL_SAVE_PATH=r'D:\DataSource\tensorflow-tutorial-master\Deep_Learning_with_TensorFlow\models'
MODEL_NAME='m64.ckpt'
mnist_path=r'D:\DataSource\tensorflow-tutorial-master\Deep_Learning_with_TensorFlow\datasets\MNIST_data'
...
def train(mnist):
    ...
    with tf.Session(config=config) as sess:
        ...
        for i in range(1):
            ...
            a, =sess.run([cross_entropy], feed_dict={x:reshaped_xs,y_:ys})
            print(a,a.shape)
            # print(ys,ys.shape)
